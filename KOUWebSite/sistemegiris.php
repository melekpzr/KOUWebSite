...
<header>
   ...
   <img src="logo.jpg"  alt="KOCAELİ ÜNİVERSİTESİ"  title="KOCAELİ ÜNİVERSİTESİ"    id="logo"/>
       ...
       <li class="dropdown">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
						<li><a href="h#">Akademik Takvim</a></li>
...
<div class="container">
<div class="page-header">
<h2>BİLGİSAYAR MÜHENDİSLİĞİ SİSTEMİNE GİRİŞ</h2>
</div>

<form action = "sys_kontrol.php" method = "post" class="form-horizontal">
<img src="image.ico">
<div class = "mesaj">Yetkili Personel Dışında Giriş Yapılamaz!</div>
  
  <div id="kul" class="form-group" >   
  
    <div class = "col-md-6">
	
	<input type="kulAdi" class="form-control input-lg" id="exampleInputKulAdi" name = "username" placeholder="Kullanıcı Adınız">
	</div>
  </div>
  <div id="sif" class="form-group">
  
   <div class = "col-md-6"> <input type="sifre" class="form-control input-lg" name = "password" id="exampleInputSifre" placeholder="Şifreniz"><i class="fa fa-unlock-alt" aria-hidden="true"></i></div>
   
  </div>
  <div class = "butonlar">
  <button type="oturumAc" class="btn btn-lg">Oturum Aç</button>
  
  <!-- bu kısımda sıkıntı var -->
  
  <a href="sifreDegistir.php"><button type="sifreDegis" class="btn btn-lg">Şifre Değiştir</button></a>
  </div>
</form>
</div>
</div>
